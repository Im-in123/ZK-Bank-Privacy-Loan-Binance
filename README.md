...
- NB: For some reason zpass verification dont work and throws "check app id"  when the frontend is deployed on  . But works totally fine of codepsaces or local server. Im currently finding a fix for the vercel frontend.
